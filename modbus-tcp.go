// Package modbusclient provides modbus RTU and TCP access for client (master) applications to communicate with server (slave) devices. Logic specifically in this file implements the TCP protocol.
